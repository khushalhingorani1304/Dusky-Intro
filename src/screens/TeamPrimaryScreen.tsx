...
interface TeamPrimaryScreenProps {
  title: string;
  subtitle: string;
...
export const TeamPrimaryScreen: React.FC<TeamPrimaryScreenProps> = ({
  title,
  subtitle,
  options,
  selectedOption,
    ...
    <div ref={containerRef} className="flex flex-col items-center min-h-screen bg-dusky-flow">
      ...
      <div className="max-w-[50.4rem] w-full px-6 flex-1 flex items-center mt-[6rem]">
        <div className="w-full">
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-2 team-heading">{title}</h2>
